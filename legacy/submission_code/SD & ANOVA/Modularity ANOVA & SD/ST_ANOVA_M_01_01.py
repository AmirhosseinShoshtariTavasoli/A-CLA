# Statistical analysis for Modularity results
# --------------------------------------------
# Input:  result.xlsx  (10 runs per dataset × method)
# Output: modularity_std.xlsx   (mean ± std)
#         anova_modularity.xlsx (ANOVA + Tukey HSD results)
...
OUT_STD = "modularity_std.xlsx"
OUT_ANOVA = "anova_modularity.xlsx"
